...
export class MainToolbar extends React.Component<IToolbarProps, IToolbarState> {
    ...
    public render(): React.ReactNode {
        ...
        const chart =
            <Menu>
                {/*//@ts-ignore*/}
                <MenuItem text="添加图表" icon={<Icon src="plus.svg" />} onClick={() => this._editor.addBuiltInPlugin("chart")} />
            </Menu>
        ...
        return (
            <ButtonGroup large={false} style={{ marginTop: "auto", marginBottom: "auto" }}>
                ...
                <Popover content={chart} position={Position.BOTTOM_LEFT} hasBackdrop={false}>
                    {/*//@ts-ignore*/}
                    <Button icon={<Icon src="dog.svg"/>} rightIcon="caret-down" text="图表"/>
                </Popover>
            </ButtonGroup>
        );
    }
