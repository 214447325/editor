    ...
    public onContextMenu(item: IAssetComponentItem, e: React.MouseEvent<HTMLImageElement, MouseEvent>): void {
        ...
        ContextMenu.show(
            <Menu className={Classes.DARK}>
                <MenuItem text="Refresh..." icon={
                    //@ts-ignore
                    <Icon src="recycle.svg" />} onClick={() => this._refreshMeshPreview(item.id, item.key)} />
                <MenuDivider />
                ...
                <MenuItem text="Export To" icon="export">
                    <MenuItem text="To Babylon..." icon={
                        //@ts-ignore
                        <Icon src="logo-babylon.svg" style={{ filter: "none" }} />} onClick={() => SceneTools.ExportMeshAssetToBabylonJSFormat(this.editor, item.id)} />
                    <MenuItem text="To GLB..." icon={
                        //@ts-ignore
                        <Icon src="gltf.svg" style={{ filter: "none" }} />} onClick={() => SceneTools.ExportMeshAssetToGLTF(this.editor, item.id, "glb")} />
                    <MenuItem text="To GLTF..." icon={
                        //@ts-ignore
                        <Icon src="gltf.svg" style={{ filter: "none" }} />} onClick={() => SceneTools.ExportMeshAssetToGLTF(this.editor, item.id, "gltf")} />
                </MenuItem>
                <MenuDivider />
                <MenuItem text="Remove" icon={
                    //@ts-ignore
                    <Icon src="times.svg" />} onClick={() => this._handleRemoveMesh(item)} />
            </Menu>,
