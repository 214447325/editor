                ...
                <div className={Classes.FILL} key="materials-toolbar" style={{ width: "100%", height: "25px", backgroundColor: "#333333", borderRadius: "10px", marginTop: "5px" }}>
                    <ButtonGroup>
                        ...
                        <Button key="clear-unused" icon={
                            //@ts-ignore
                            <Icon src="recycle.svg" />} small={true} text="Clear Unused" onClick={() => this._clearUnusedMaterials()} />
                    </ButtonGroup>
                </div>
                {node}
            </>
    ...
    public onContextMenu(item: IAssetComponentItem, e: React.MouseEvent<HTMLImageElement, MouseEvent>): void {
        ...
        ContextMenu.show(
            <Menu className={Classes.DARK}>
                ...
                <MenuDivider />
                <MenuItem text="Locked" icon={material.metadata.isLocked ?
                    //@ts-ignore
                    <Icon src="check.svg" /> : undefined} onClick={() => {
                ...
                <MenuItem text="Remove" icon={
                    //@ts-ignore
                    <Icon src="times.svg" />} onClick={() => this._handleRemoveMaterial(item)} />
            </Menu>,
