...
export class CinematicAnimationKeyInspector extends AbstractInspector<CinematicAimationKey, ICinematicAnimationKeyInspectorState> {
	...
	private _getTangentInspectorFor(animationType: number, key: IAnimationKey, property: "inTangent" | "outTangent"): React.ReactNode {
		...
		switch (animationType) {
			...
			{/*//@ts-ignore*/}
				tangentField = <InspectorNumber key={Tools.RandomId()} object={key} property={property} label="Value" />; break;
			case Animation.ANIMATIONTYPE_VECTOR2:
			{/*//@ts-ignore*/}
				tangentField = <InspectorVector2 key={Tools.RandomId()} object={key} property={property} label="Value" />; break;
			case Animation.ANIMATIONTYPE_VECTOR3:
			{/*//@ts-ignore*/}
				tangentField = <InspectorVector3 key={Tools.RandomId()} object={key} property={property} label="Value" />; break;
